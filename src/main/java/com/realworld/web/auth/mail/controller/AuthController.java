...
public class AuthController {
    ...
    public ResponseEntity<SuccessResponse<String>> checkAuthMail(@Parameter(description = "유저 이메일", example = "test@naver.com") @RequestParam("user_email") String userEmail, @Parameter(description = "인증번호", example = "asdf15130")@PathVariable("auth_number") String authNumber) {
